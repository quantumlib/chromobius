...
DETECTOR(2, 0, 0, 3) rec[-10]
DETECTOR(2, 2, 0, 5) rec[-11]
DETECTOR(3, 1, 0, 1) rec[-34] rec[-3]
DETECTOR(3, 3, 0, 0) rec[-33] rec[-4]
DETECTOR(3, 5, 0, 2) rec[-32] rec[-5]
DETECTOR(4, 1, 0, 4) rec[-12]
DETECTOR(4, 3, 0, 3) rec[-13]
DETECTOR(4, 5, 0, 5) rec[-14]
DETECTOR(5, 0, 0, 0) rec[-31] rec[-6]
DETECTOR(5, 2, 0, 2) rec[-30] rec[-7]
DETECTOR(5, 4, 0, 1) rec[-29] rec[-8]
DETECTOR(6, 0, 0, 3) rec[-15]
DETECTOR(6, 2, 0, 5) rec[-16]
DETECTOR(6, 4, 0, 4) rec[-17]
DETECTOR(7, 1, 0, 1) rec[-28] rec[-9]
DETECTOR(8, 1, 0, 4) rec[-18]
SHIFT_COORDS(0, 0, 1)
TICK
R 36 31 29 27 19 17 15 6 4
RX 33 25 23 21 13 11 9 3 1
